...
var row_count, col_count, mine_count;
...
function ExpandMineArea(source)
{
    ...
    switch (temp_value)
    {
        ...
        case 1:
            oMine.className = "mine_down_1";
            oMine.innerText = "1";
            oMine.setAttribute("expanded", true);
            break;
        case 2:
            oMine.className = "mine_down_2";
            oMine.innerText = "2";
            oMine.setAttribute("expanded", true);
            break;
        case 3:
            oMine.className = "mine_down_3";
            oMine.innerText = "3";
            oMine.setAttribute("expanded", true);
            break;
        case 4:
            oMine.className = "mine_down_4";
            oMine.innerText = "4";
            oMine.setAttribute("expanded", true);
            break;
        case 5:
            oMine.className = "mine_down_5";
            oMine.innerText = "5";
            oMine.setAttribute("expanded", true);
            break;
        case 6:
            oMine.className = "mine_down_6";
            oMine.innerText = "6";
            oMine.setAttribute("expanded", true);
            break;
        case 7:
            oMine.className = "mine_down_7";
            oMine.innerText = "7";
            oMine.setAttribute("expanded", true);
            break;
        case 8:
            oMine.className = "mine_down_8";
            oMine.innerText = "8";
            oMine.setAttribute("expanded", true);
            break;
        //bomb blast
